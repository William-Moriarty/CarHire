...
<html lang='en'>
  <head>
    <title>AutoHire Tralee - Admin/Update customer</title>
    <meta charset='utf-8'>
...
<?php 
if ($id == '')  {
echo('<em>NO ID ENTERED, PLEASE RENTURN TO MANAGE CUSTOMERS AND ENTER AN ID</em>');
}
 ?>
</div>
...
<legend>Update a Customer</legend>
   <form action="success-cust-update.php" method="post">
    <input type="hidden" name="ud_id" value="<?php echo $id; ?>">
    
    <label>Address: </label>
    <input type="text" name="ud_address" value="<?php echo $address; ?>"><br /> 
      
    <label>Email:</label> 
    <input type="text" name="ud_email" value="<?php echo $email; ?>"><br />
     
     <label>Phone No:</label> 
    <input type="text" name="ud_phone" value="<?php echo $phone; ?>"><br />
