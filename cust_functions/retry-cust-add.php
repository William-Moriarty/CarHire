...
<html lang='en'>
  <head>
    <title>AutoHire Tralee - Join Us! (Retry!)</title>
    <meta charset='utf-8'>
...
?> 
  ...
  <div class="logindiv">
    <fieldset>
      ...
      <form action= "retry-cust-add.php" method="post">
...
<fieldset>
 ...
 <form action="add-a-customer.php" method="post">
 
  <label>First Name:</label>
  <input type="text" name="cust_forename"><br>

  <label>Surname:</label>
  <input type="text" name="cust_surname"><br>
  
  <label>Address:</label>
  <input type="text" name="cust_address" ><br>
...
<div id="submitdiv">
<input type="submit" name="submit_cust_details" value="Submit">
