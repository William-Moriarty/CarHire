...
<html lang='en'>
  <head>
    <title>AutoHire Tralee - Hire a car! (Retry)</title>
    <meta charset='utf-8'>
...
?> 
  ...
  <div class="logindiv">
    <fieldset>
      ...
      <form action= "retry-hire-add.php" method="post">
...
<fieldset>
 ...
 <form action="add-a-hire.php" method="post">
 
  <label>Date From:</label>
  <input type="text" name="hire_date_from"><br>

  <label>Date To:</label>
  <input type="text" name="hire_date_to"><br>
  
  <label>Your customer Id</label>
  <input type="text" name="hire_custid" ><br>

  <label>Car Id that you would like to rent:</label>
  <input type="text" name="hire_carid"><br>
  

<div id="submitdiv">
<input type="submit" name="submit_hire_details" value="Submit">
