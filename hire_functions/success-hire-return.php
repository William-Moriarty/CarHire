...
<html lang='en'>
  <head>
    <title>AutoHire Tralee - Admin/Return Car</title>
    <meta charset='utf-8'>
...
$ud_id           =$_POST['ud_id'];
$ud_return       =$_POST['ud_return'];


$sql="UPDATE hires SET returned ='$ud_return' WHERE hireid=$ud_id";
...
if ( !$res ) {
  ...
  echo "<p><em> No Return update added</em></p>";  }
   else
  {
echo "Return has been recorded";}
