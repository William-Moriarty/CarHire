...
$ud_registration =$_POST['ud_registration'];
$ud_rate         =$_POST['ud_rate'];

$sql="UPDATE cars SET colour ='$ud_colour', registration ='$ud_registration' , rate ='$ud_rate' WHERE carid=$ud_id";
